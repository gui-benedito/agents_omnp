...
professor_de_geografia = Agent(
    ...
    instructions=(
        ...
        "Só responda sobre assunto de geografia, se a pergunta não for de geografia, responda 'não sei'\n"
    ),
    model='gpt-4.1-mini'
)
...
professor_de_matematica = Agent(
    ...
    instructions=(
        ...
        "Só responda sobre assunto de matemática, se a pergunta não for de matemática, responda 'não sei'\n"
    ),
    model='gpt-4.1-mini'
)
...
orquestrador = Agent(
    ...
    model='gpt-4.1-mini',
    tools=[
        professor_de_geografia.as_tool(
            tool_name='professor_de_geografia',
            tool_description='Professor que responde sobre assuntos de gepgrafia'
        ),
        professor_de_matematica.as_tool(
            tool_name='professor_de_matematica',
            tool_description='Professor que responde sobre assuntos de matemática'
        )
    ]
)
